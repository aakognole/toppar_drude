...
#setenv charmm /opt/mackerell/apps/charmm/serial/c44b2-serial
#        setenv charmm /opt/mackerell/apps/charmm/serial/charmm-serial
#        setenv charmm /home/fylin/charmm_test/charmm
        set all = $1
    else
...
#mkdir -p $outdir
$charmm mindr:0 mini:0 test:$all < test_drude_all_2020_auto_all.inp > $outdir/test_drude_all_2020b_auto_all_c44b2.out 
